...
public class Menu extends javax.swing.JPanel {
    ...
    private void enviarDatos() throws FileNotFoundException {
        ...
        if (!(quiereLeer || quiereEscribir)) {
            ...
            if (nombresArchivos.contains(textoNombre)) {
                advertencia.setText("El archivo que quiere crear ya existe, ingrese otro nombre");
                ctrl.ajustarVentana();
//            } else {
//                
//            }
                ...
                if (!textoNombre.isBlank() && !valorCombo.equals("Ninguno")) {
                    ...
                    String nombreCrear = formatear(textoNombre);
                    ctrl.irVentanaEscitores(nombreCrear, true);
                } else if (!valorCombo.equals("Ninguno")) {
                    ctrl.irVentanaEscitores(valorCombo, false);
                } else {
    ...
    LinkedList<String> nombresArchivos = new LinkedList<>();
